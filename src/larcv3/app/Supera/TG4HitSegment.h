...
public:
    ...
    const larcv::SLorentzvector& GetStart() const {return Start;}

    /// The stopping position of the segment.
    const larcv::SLorentzvector& GetStop() const {return Stop;}
...
private:
    ...
    /// The starting position of the segment.
    larcv::SLorentzvector Start;

    /// The stopping position of the segment.
    larcv::SLorentzvector Stop;
};
#endif

...
/// A class to save a G4 trajectory into a rooooooot output file without linking to
...
public:
    ...
    const larcv::SLorentzvector& GetInitialMomentum() const {return InitialMomentum;}
...
private:
    ...
    /// The initial momentum of the particle
    larcv::SLorentzvector InitialMomentum;

};


/// A class to save a G4 trajectory point into a rooooooooooot output file without
